  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: "flex items-center gap-1 z-10",
        button_previous: cn(
          buttonVariants({ variant: "outline" }),
          "cursor-pointer size-7 top-0 bg-transparent p-0 opacity-50 hover:opacity-100 absolute left-0",
        ),
        button_next: cn(
          buttonVariants({ variant: "outline" }),
          "cursor-pointer size-7 top-0 bg-transparent p-0 opacity-50 hover:opacity-100 absolute right-0",
        ),
